#ifndef LCFIVERTEXMOMENTUM_H
#define LCFIVERTEXMOMENTUM_H
...
namespace vertex_lcfi
{
	...
	/*!%Jet flavour tagging parameter algorithm that returns the momentum of the seed vertex. 
	...
	*/
	...
	public:
		...
		*/
		...
		\return double the momentum of the seed secondary vertex with all attached tracks. 
		*/
